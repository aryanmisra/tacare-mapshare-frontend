...
export function Home(): React.ReactElement {
    ...
    return (
        <>
            ...
            <div
                style={{ pointerEvents: !loaded ? "auto" : "none", opacity: !loaded ? 1 : 0, transition: "0.5s cubic-bezier(.69,.09,.37,.94)" }}
            ...
            <div className="body-container">
                <div className="globe-container">
                    <GlobeMap
                        publishNewBranch={publishNewBranch}
                        exportMap={exportMap}
                ...
                {mapEditMode && (
                    <div className="modify-layer-container">
                        <button onClick={() => setExportMap(true)} className="modify-button-1">
                            Submit changes
                        </button>
                        <button onClick={stopNewBranch} className="modify-button-2">
                            Cancel
                        </button>
                    </div>
                )}
